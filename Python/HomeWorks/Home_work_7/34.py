...
def calculate_vowels(word):
    """Функция для расчета количества гласных в слове"""
    vowels = "aeiouy"
    count = 0
...
# разбиваем поэму на фразы
phrases = poem.split()

# вычисляем количество гласных букв в каждой фразе
vowels = [calculate_vowels(phrase.replace('-', '')) for phrase in phrases]

# проверяем, все ли количества гласных букв одинаковые
